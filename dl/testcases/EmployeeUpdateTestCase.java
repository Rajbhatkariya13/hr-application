...
employee.setEmployeeId(Keyboard.getString("Enter the Empoyee Id which is to update : "));
...
System.out.println("Employee updated with Employee Id: "+employee.getEmployeeId());
